...
// ===== SATURDAY: Partner Power =====
const saturday: DayTemplate = {
  dayLabel: "Partner Power (Date Night Prep)",
  dayTheme: "partner",
  dayOfWeek: 6,
  slots: [
    {
      slotName: "Partner Back",
      slotType: "rotating",
      exercisesByWeek: { 1: "partner-db-row", 2: "partner-band-row", 3: "partner-db-row", 4: "partner-band-row", 5: "partner-db-row" },
      setsByWeek: PROG_4_ALL,
      repsByWeek: { 1: "10/side", 2: "15", 3: "10/side", 4: "15", 5: "10/side" },
      restSeconds: 0,
      notes: "You-Go-I-Go, no rest between partners",
    },
    {
      slotName: "Partner Arms",
      slotType: "fixed",
      exercisesByWeek: fixed("gun-run-curl"),
      setsByWeek: { 1: 1, 2: 1, 3: 1, 4: 1, 5: 1 },
      repsByWeek: { 1: "Ladder to 10", 2: "Ladder to 10", 3: "Ladder to 12", 4: "Ladder to 10", 5: "Ladder to 12" },
      restSeconds: 0,
      notes: "A does 1, B does 1, A does 2... to the top",
    },
    {
      slotName: "Partner Legs",
      slotType: "rotating",
      exercisesByWeek: { 1: "partner-wall-sit", 2: "partner-squat-toss", 3: "partner-wall-sit", 4: "partner-squat-toss", 5: "partner-wall-sit" },
      setsByWeek: PROG_3_ALL,
      repsByWeek: { 1: "45-60s", 2: "20", 3: "45-60s", 4: "20", 5: "60s" },
      restSeconds: 30,
      notes: "Pass a weight back and forth / communicate!",
    },
    {
      slotName: "Partner Power",
      slotType: "fixed",
      exercisesByWeek: fixed("med-ball-slam"),
      setsByWeek: PROG_3_ALL,
      repsByWeek: { 1: "20", 2: "20", 3: "25", 4: "20", 5: "25" },
      restSeconds: 30,
      notes: "Power & frustration release!",
    },
    {
      slotName: "Partner Triceps",
      slotType: "fixed",
      exercisesByWeek: fixed("partner-tricep-kickback"),
      setsByWeek: PROG_3_ALL,
      repsByWeek: { 1: "15", 2: "15", 3: "15", 4: "15", 5: "15" },
      restSeconds: 0,
      notes: "Keep the tension high, alternate",
    },
    {
      slotName: "Partner Core",
      slotType: "fixed",
      exercisesByWeek: fixed("high-five-plank"),
      setsByWeek: PROG_3_ALL,
      repsByWeek: { 1: "45 sec", 2: "45 sec", 3: "60 sec", 4: "60 sec", 5: "60 sec" },
      restSeconds: 30,
      notes: "Clap opposite hands every 5 sec",
    },
  ],
};
